...
const servicesMenu = [
  ...
  },
  {
    ...
    items: [
      { label: "Particuliers", href: "/assainissement-particulier", desc: "Maison individuelle, urgences, fosse" },
      ...
      { label: "Industrie & Entreprises", href: "/assainissement-industrie", desc: "Séparateur HC, nettoyage industriel" },
      { label: "BTP & Chantiers", href: "/assainissement-chantier-btp", desc: "Nettoyage sol, balayage après travaux" },
      { label: "Collectivités & Mairies", href: "/assainissement-collectivite", desc: "Voirie, routes, espaces publics" },
      { label: "Hôtels & Campings", href: "/assainissement-hotel-camping", desc: "Fosses, bacs graisses, réseau" },
